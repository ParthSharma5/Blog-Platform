...
date: "2026-02-23"
description: "Deeper Dive into Cloud Computing "
---
...
1. Peak traffic  ? Add more resources
2. Less traffic ? Shut down resources
3. You only pay what you use
...
```
It involves increasing the capacity of existing nodes/machines
For example If a server requires more processing power vertical scaling
involves upgrading the CPU's Similarly storage can be dynamically upgraded or
degraded
...
```
When you need to handle new demand Horizontal scaling involves adding more nodes
machines to your infrastructure
if a application is hosted on a server is struggling to manage traffic due to the
lack of capacity or capability .The solution may be add to another server.
